...
export default function Register() {
    ...
    const handleRegister = async (e) => {
        ...
        if (!username.trim() || !email.trim() || !password) {
            setError('Please complete all requirements to proceed.');
            return;
        }
                    ...
                    <div className="lp-card-wrap">
                        <div className="lp-card" ref={cardRef}>
                            ...
                            <div className={`lp-success-overlay${success ? ' visible' : ''}`}>
                                ...
                                <div className="lp-success-title">Welcome to CloudVault</div>
                                <div className="lp-success-subtitle">Preparing your secure storage…</div>
                            </div>
                            ...
                            <div className="lp-logo-wrap">
                                ...
                                <div className="lp-logo-tagline">Create your workspace</div>
                            </div>
                            ...
                            <form onSubmit={handleRegister} noValidate>
                                {/* Username */}
                                <div className="lp-field lp-field-1" style={{ marginBottom: '16px' }}>
                                ...
                                {/* Email */}
                                <div className="lp-field lp-field-2" style={{ marginBottom: '16px' }}>
                                ...
                                {/* Password */}
                                <div className="lp-field lp-field-3">
                                ...
                                {/* Submit */}
                                <div className="lp-btn-wrap" style={{ marginTop: '24px' }}>
                                    <button
                                        id="lp-register-btn"
                                        ref={btnRef}
                                        type="submit"
                                        ...
                                        disabled={loading}
                                    >
                                        <span className="lp-btn-text">Join CloudVault</span>
                            ...
                            {/* Divider + Social */}
                            <div className="lp-divider" style={{ marginTop: '24px' }}><span>or register with</span></div>
                            ...
                            {/* Footer */}
                            <div className="lp-card-footer" style={{ marginTop: '24px' }}>
